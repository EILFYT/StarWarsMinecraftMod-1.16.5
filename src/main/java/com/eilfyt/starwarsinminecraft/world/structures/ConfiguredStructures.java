...
public class ConfiguredStructures {
     ...
     */
    public static StructureFeature<?, ?> CONFIGURED_WIZARD_TOWER = Structures.WIZARD_TOWER.get().configured(IFeatureConfig.NONE);
    public static StructureFeature<?, ?> CONFIGURED_DEATH_STAR = Structures.DEATH_STAR.get().configured(IFeatureConfig.NONE);
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(StarWarsInMinecraft.MOD_ID, "configured_wizard_tower"), CONFIGURED_WIZARD_TOWER);
        Registry.register(registry, new ResourceLocation(StarWarsInMinecraft.MOD_ID, "configured_death_star"), CONFIGURED_DEATH_STAR);
         ...
         */
        FlatGenerationSettings.STRUCTURE_FEATURES.put(Structures.WIZARD_TOWER.get(), CONFIGURED_WIZARD_TOWER);
        FlatGenerationSettings.STRUCTURE_FEATURES.put(Structures.DEATH_STAR.get(), CONFIGURED_DEATH_STAR);
    }
}