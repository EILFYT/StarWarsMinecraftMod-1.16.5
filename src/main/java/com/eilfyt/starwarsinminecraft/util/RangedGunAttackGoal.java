...
public class RangedGunAttackGoal<T extends StormTrooperEntity & IRangedAttackMob> extends Goal {
    ...
    public RangedGunAttackGoal(T p_i47515_1_, double p_i47515_2_, int p_i47515_4_, float p_i47515_5_) {
    ...
    protected boolean isHoldingGun() {
        return this.mob.isHolding(item -> item instanceof Gun);
    }
    ...
    public void tick() {
        ...
        if (livingentity != null) {
            ...
            if (this.mob.isUsingItem()) {
                ...
                this.mob.startUsingItem(ProjectileHelper.getWeaponHoldingHand(this.mob, RegistryHandler.BLASTER.get()));
            }
