...
public class MagmaStaff extends Item {
    public MagmaStaff() {
        super(new Properties().tab(StarWarsInMinecraft.TAB).stacksTo(1).fireResistant());
    }
    ...
    public ActionResult<ItemStack> use(World p_77659_1_, PlayerEntity p_77659_2_, Hand p_77659_3_) {
        ...
        FireballEntity fbEntity = new FireballEntity(p_77659_1_, p_77659_2_, d2, d3, d4);
            fbEntity.explosionPower = 2;
