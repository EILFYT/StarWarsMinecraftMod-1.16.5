...
public class StormTrooperRenderer extends MobRenderer<StormTrooperEntity, StormTrooperModel<StormTrooperEntity>> {
    ...
    protected static final ResourceLocation STORMTROOPER_MODEL = new ResourceLocation(StarWarsInMinecraft.MOD_ID, "textures/entity/stormtrooper.png");

    public StormTrooperRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn, new StormTrooperModel<>(), 0.7f);
    }
