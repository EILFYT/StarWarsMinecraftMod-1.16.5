...
import com.neonfish.starwarsinminecraft.armor.ModArmorMaterial;
import com.neonfish.starwarsinminecraft.blocks.*;
import com.neonfish.starwarsinminecraft.init.ModEntityTypes;
import com.neonfish.starwarsinminecraft.items.*;
import com.neonfish.starwarsinminecraft.tools.ModItemTier;
...
//idek anymore man
    ...
    public static final RegistryObject<SwordItem> KYBERCRYSTAL_SWORD = ITEMS.register("blue_lightsaber", () ->
            new SwordItem(ModItemTier.KYBERCRYSTAL, 16, -1.2f, new Item.Properties().group(StarWarsInMinecraft.TAB))
            );
    ...
    public static final RegistryObject<PickaxeItem> KYBERCRYSTAL_PICKAXE = ITEMS.register("kyber_pickaxe", () ->
            new PickaxeItem(ModItemTier.KYBERCRYSTAL, 6, -2.0f, new Item.Properties().group(StarWarsInMinecraft.TAB))
    );

    public static final RegistryObject<AxeItem> KYBERCRYSTAL_AXE = ITEMS.register("kyber_axe", () ->
            new AxeItem(ModItemTier.KYBERCRYSTAL, 18, -2.4f, new Item.Properties().group(StarWarsInMinecraft.TAB))
    );

    public static final RegistryObject<ShovelItem> KYBERCRYSTAL_SHOVEL = ITEMS.register("kyber_shovel", () ->
            new ShovelItem(ModItemTier.KYBERCRYSTAL, 5, -2.0f, new Item.Properties().group(StarWarsInMinecraft.TAB))
    );

    public static final RegistryObject<HoeItem> KYBERCRYSTAL_HOE = ITEMS.register("kyber_hoe", () ->
            new HoeItem(ModItemTier.KYBERCRYSTAL, 4, -2.0f, new Item.Properties().group(StarWarsInMinecraft.TAB))
    );

    public static final RegistryObject<SwordItem> DRAGON_SOUL_SWORD = ITEMS.register("dragon_soul_sword", () ->
            new SwordItem(ModItemTier.DRAGON_SOUL, 18, 1000.0f, new Item.Properties().group(StarWarsInMinecraft.TAB))
    );

    public static final RegistryObject<PickaxeItem> DRAGON_SOUL_PICKAXE = ITEMS.register("dragon_soul_pickaxe", () ->
            new PickaxeItem(ModItemTier.DRAGON_SOUL, 7, -2.0f, new Item.Properties().group(StarWarsInMinecraft.TAB))
    );

    public static final RegistryObject<AxeItem> DRAGON_SOUL_AXE = ITEMS.register("dragon_soul_axe", () ->
            new AxeItem(ModItemTier.DRAGON_SOUL, 20, -2.0f, new Item.Properties().group(StarWarsInMinecraft.TAB))
    );

    public static final RegistryObject<ShovelItem> DRAGON_SOUL_SHOVEL = ITEMS.register("dragon_soul_shovel", () ->
            new ShovelItem(ModItemTier.DRAGON_SOUL, 6, -2.0f, new Item.Properties().group(StarWarsInMinecraft.TAB))
    );
    ...
    public static final RegistryObject<ArmorItem> KYBER_HELMET = ITEMS.register("kyber_helmet", () ->
            new ArmorItem(ModArmorMaterial.KYBERCRYSTAL, EquipmentSlotType.HEAD, new Item.Properties().group(StarWarsInMinecraft.TAB)));

    public static final RegistryObject<ArmorItem> KYBER_LEGGINGS = ITEMS.register("kyber_leggings", () ->
            new ArmorItem(ModArmorMaterial.KYBERCRYSTAL, EquipmentSlotType.LEGS, new Item.Properties().group(StarWarsInMinecraft.TAB)));


    public static final RegistryObject<ArmorItem> KYBER_CHESTPLATE = ITEMS.register("kyber_chestplate", () ->
            new ArmorItem(ModArmorMaterial.KYBERCRYSTAL, EquipmentSlotType.CHEST, new Item.Properties().group(StarWarsInMinecraft.TAB)));

    public static final RegistryObject<ArmorItem> KYBER_BOOTS = ITEMS.register("kyber_boots", () ->
            new ArmorItem(ModArmorMaterial.KYBERCRYSTAL, EquipmentSlotType.FEET, new Item.Properties().group(StarWarsInMinecraft.TAB)));

    public static final RegistryObject<ArmorItem> DRAGON_SOUL_HELMET = ITEMS.register("dragon_soul_helmet", () ->
            new ArmorItem(ModArmorMaterial.DRAGON_SOUL, EquipmentSlotType.HEAD, new Item.Properties().group(StarWarsInMinecraft.TAB)));

    public static final RegistryObject<ArmorItem> DRAGON_SOUL_CHESTPLATE = ITEMS.register("dragon_soul_chestplate", () ->
            new ArmorItem(ModArmorMaterial.DRAGON_SOUL, EquipmentSlotType.CHEST, new Item.Properties().group(StarWarsInMinecraft.TAB)));

    public static final RegistryObject<ArmorItem> DRAGON_SOUL_LEGGINGS = ITEMS.register("dragon_soul_leggings", () ->
            new ArmorItem(ModArmorMaterial.DRAGON_SOUL, EquipmentSlotType.LEGS, new Item.Properties().group(StarWarsInMinecraft.TAB)));
