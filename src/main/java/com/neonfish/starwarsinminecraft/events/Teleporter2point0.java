...
import com.neonfish.starwarsinminecraft.blocks.MustafarPortalBlock;
...
public class Teleporter2point0 extends Teleporter {
    ...
    public Optional<TeleportationRepositioner.Result> getExistingPortal(BlockPos pos, boolean isMustafar) {
